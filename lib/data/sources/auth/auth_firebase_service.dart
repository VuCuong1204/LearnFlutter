...
import 'package:learn_app/core/constants/app_urls.dart';
...
import 'package:learn_app/data/models/auth/user.dart';
import 'package:learn_app/domain/entities/auth/user.dart';
...
class AuthFirebaseServiceImpl extends AuthFirebaseService {
  ...
  Future<Either> getUser() async {
    try {
      ...
      return const Left('An error occurreed');
    }
  }
